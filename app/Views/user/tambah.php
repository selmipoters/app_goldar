                ...
                <div class="card-body fs-6 p-10 p-lg-15">
                    ...
                    <div class="card-header border-0 pt-5">
                        ...
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column card-label fw-bolder fs-3 mb-1">Tambah Data User</h3>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Input group-->
                        <div class="mb-13 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" value="<?php echo $newkd_user ?>" name="kd_user" id="kd_user" readonly="readonly" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Masukan Nama" name="nama" id="nama" required />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Masukan Username" name="username" id="username" required />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
