            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="" data-bs-original-title="Click to add a user">
                        <a href="<?php echo base_url('user/tambah') ?>" class="btn btn-sm btn-light-primary tombol-tambah" data-bs-target="#kt_modal_invite_friends">
                            ...
                            <tbody>
                                ...
                                foreach ($user as $user) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-dark fw-bolder text-hover-primary d-block fs-6"><?php echo $user['hak_akses'] ?></span>
                                        </td>
                                        <td class="text-end">
                                            <a href="<?php echo base_url('user/edit/' . $user['kd_user']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            ...
                                            <a href="<?php echo base_url('user/delete/' . $user['kd_user']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm tombol-hapus">
